...
python run.py web --port 8802              # 起 Web 页（复用基线的前端）
python tests/test_graph.py                 # 47 项，不需要 Dify / API Key / 联网
python tests/test_web.py                   # 27 项
python tests/test_tools.py                 # 13 项
```
